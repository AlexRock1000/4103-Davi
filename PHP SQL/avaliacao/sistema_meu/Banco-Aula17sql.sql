...
-- Copiando dados para a tabela sistema_estoque.clientes: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela sistema_estoque.produtos: ~3 rows (aproximadamente)
INSERT IGNORE INTO `produtos` (`id`, `codigo`, `nome`, `categoria`, `quantidade`, `valor_compra`, `valor_venda`, `imagem`, `data_cadastro`) VALUES
	...
	(6, '002', 'controle', 'game', 100, 150.00, 300.00, '6a2c410237b85.png', '2026-06-12 14:25:22'),
...
-- Copiando dados para a tabela sistema_estoque.vendas: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela sistema_estoque.vendas_itens: ~5 rows (aproximadamente)
