...
-- Copiando dados para a tabela sistema_estoque.produtos: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela sistema_estoque.vendas_itens: ~0 rows (aproximadamente)
