    ...
    <div class="container">
        ...
        <div id="navbarMenu" class="navbar-menu">
            <div class="navbar-start">
                <a class="navbar-item" href="#/clientes/index.php">Clientes</a>
                <a class="navbar-item" href="#/produtos/index.php">Produtos</a>
                <a class="navbar-item" href="#/vendas/index.php">Vendas</a>
            </div>
